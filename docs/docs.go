...
// 2019-12-29 21:40:19.291306 +0800 CST m=+0.113212670
...
var doc = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/server.ActivityListResponse"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/server.ActivityAddRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.ActivityAddResponse"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/server.ActivityDelRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.ActivityDelResponse"
                        }
                    }
                }
            }
        },
        "/activitys/all_prize_issued": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.ActivityAllPrizeIssuedResponse"
                        }
                    }
                }
            }
        },
        "/activitys/currently_available": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.ActivityCurrentlyAvailableResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.ActivityDetailResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/server.ActivityAddPrizeNumberRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.ActivityAddPrizeNumberResponse"
                        }
                    }
                }
            }
        },
        "/activitys/participant": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.ActivityParticipantListResponse"
                        }
                    }
                }
            }
        ...
        "/customers/can_part_lucky_number_activity": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.CanPartLuckyNumberActivityResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.LuckyPeopleBeforeResponse"
                        }
                    }
                }
            }
        },
        "/customers/lucky_number": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.LuckyNumberDetailResponse"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/server.LuckyNumberAddRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.LuckyNumberAddResponse"
                        }
                    }
                }
            }
        },
        "/customers/lucky_number/before": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.LuckyNumberBeforeResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.CheckinStatResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"status\":true}",
                        "schema": {
                            "$ref": "#/definitions/server.RegisterStatResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "server.ActivityAddPrizeNumberRequest": {
            "type": "object",
            "required": [
                "prize_number"
            ],
        ...
        "server.ActivityAddPrizeNumberResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "业务状态码",
        ...
        "server.ActivityAddRequest": {
            ...
            "properties": {
                ...
                "scope": {
                    "description": "参与方式：O：无限制；R：必须在福利签领取过签到奖励",
                    "type": "string"
                },
                "start_time": {
                    "description": "开始时间",
        ...
        "server.ActivityAllPrizeIssuedResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "业务状态码",
        ...
        "server.ActivityCurrentlyAvailableResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "业务状态码",
        ...
        "server.ActivityParticipantListResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "业务状态码",
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.LuckyNumberRecord"
                    }
                },
                "error": {
                    "description": "Error信息",
        ...
        "server.CanPartLuckyNumberActivityResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "业务状态码",
        ...
        "server.CheckinStatResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.CheckinStat"
                    }
                },
                "error": {
                    "description": "Error信息",
        ...
        "server.LuckyNumberBeforeResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "业务状态码",
        ...
        "server.LuckyNumberDetailResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "业务状态码",
        ...
        "server.LuckyPeopleBeforeResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "业务状态码",
        ...
        "server.RegisterStatResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.RegisterStat"
                    }
                },
                "error": {
                    "description": "Error信息",
